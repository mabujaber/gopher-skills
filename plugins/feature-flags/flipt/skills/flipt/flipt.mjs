 ...
 *   node skills/flipt/flipt.mjs get <flag-key>
 *   node skills/flipt/flipt.mjs create <flag-key> -d "description"
 *   node skills/flipt/flipt.mjs enable <flag-key>
 *   node skills/flipt/flipt.mjs disable <flag-key>
 *   node skills/flipt/flipt.mjs create <flag-key> --variant --variants "1.5,2" -d "description"
 *   node skills/flipt/flipt.mjs add-variant <flag-key> <variant-key>
 *   node skills/flipt/flipt.mjs remove-variant <flag-key> <variant-key>
 *   node skills/flipt/flipt.mjs set-rollout <flag-key> <variant-key> [--rollout 100]
 *
 * Options:
...
async function createFlag(key, desc, isEnabled) {
  ...
  try {
    ...
    console.log('\n⚠️  Note: API changes are temporary. For permanent changes, edit <your-org>/flipt-state repo.');
  } catch (err) {
    if (err.message.includes('Method Not Allowed')) {
      ...
      console.error('1. Clone: gh repo clone <your-org>/flipt-state /tmp/flipt-state');
      console.error('2. Edit: <namespace>/features.yaml');
...
use the GitOps workflow by editing the <your-org>/flipt-state repository.`);
}
